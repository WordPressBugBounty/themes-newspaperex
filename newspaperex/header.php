                    ...
                    <div class="mg-nav-widget-area">
                        <div class="row align-items-center">
                            <?php $newsup_right_banner_advertisement = newsup_get_option('banner_right_advertisement_section');         
                                   ...
                                   if(!empty($newsup_right_banner_advertisement)){  do_action('newspaperex_action_right_banner_advertisement'); }
                           ...
                           if(!empty($newsup_banner_advertisement)){ do_action('newspaperex_action_banner_advertisement'); } ?>
                        </div>
                    </div>
                </div>
              </div>
